...
#Background image
bg = pygame.image.load('data/background1.jpg')

pygame.mixer.music.load('data/high-energy.mp3')
pygame.mixer_music.play(-1)

bullet_sound = pygame.mixer.Sound('data/GUNSHOT.wav')
explosion_sound = pygame.mixer.Sound('data/a-bomb-.mp3')

#player
player_img = pygame.image.load('data/player1.png')
playerX = 368
playerY = 516
playerX_moving = 0
...
for i in range(num_of_enemies):
    enemy_img.append(pygame.image.load('data/alien. (2).png'))
    enemyX.append(random.randint(0, 736))
    enemyY.append(random.randint(20, 120))
    enemyX_moving.append(0.3)
    enemyY_moving.append(40)
    

#Bullet
bullet_img = pygame.image.load('data/Bullit (2).png')
bulletX = 0
bulletY = 516
bulletY_moving = -1
bullet_state = 'ready'
...
score_font = pygame.font.Font('data/batman_forever/batmfa__.ttf', 32)
scoreX = 10
scoreY = 10

game_over_font = pygame.font.Font('data/batman_forever/batmfa__.ttf', 64)
game_overX = 200
game_overY = 250 



restart_font = pygame.font.Font('data/Paintingwithchocolate-K5mo.ttf', 28)
restartX = 250
restartY = 400
